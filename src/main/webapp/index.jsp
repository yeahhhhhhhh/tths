...
<body>
    ...
    <form action="${pageContext.request.contextPath}/user/login" method="post">
        ...
        验证码：<input type="text" name="valistr"><img src="${pageContext.request.contextPath}/ValiImg">
    ...
    <form action="${pageContext.request.contextPath}/user/adminLogin" method="post">
        用户名：<input type="text" name="username">
        密码：<input type="text" name="password">
        valistr：<input type="text" name="valistr">
    ...
    <hr/>
    <form action="${pageContext.request.contextPath}/file/excelUpload" method="post" enctype="multipart/form-data">
        <input type="file" name="file1">
        uid:<input type="text" name="uid" value="282">
        <input type="submit" value="用excel添加老师">
    </form>
<hr/>
    <form action="${pageContext.request.contextPath}/admin/coverJobandTitle" method="post">
        typeName：<input type="text" name="typeName" value="teacher_title">
        newType：<input type="text" name="newType" value="教授,副教授,讲师,实验师,工程师,高级工程师,测试1">
        <input type="submit" value="覆盖config">
    </form>
    <hr/>
    <form action="${pageContext.request.contextPath}/file/fileListByPage" method="post">
        uid：<input type="text" name="uid" value="282">
        nowPage：<input type="text" name="nowPage" value="1">
        listCount：<input type="text" name="listCount" value="2">
        <input type="submit" value="分页查询教师文件">
    </form>
    <hr/>
    <form action="${pageContext.request.contextPath}/user/contactAdmin" method="post">
        meg：<input type="text" name="msg" value="测试留言1">
        valistr：<input type="text" name="valistr" value="111">
        <input type="submit" value="测试留言">
    </form>
    <hr/>
    <form action="${pageContext.request.contextPath}/admin/changeAdminEmail" method="post">
        email：<input type="text" name="email" value="517619345">
        <input type="submit" value="修改管理员邮箱">
    </form>
    <hr/>
    <form action="${pageContext.request.contextPath}/admin/findMsg" method="post">
        nowPage：<input type="text" name="nowPage" value="1">
        listCount：<input type="text" name="listCount" value="2">
        <input type="submit" value="查询留言">
    </form>
    <hr/>
    <form action="${pageContext.request.contextPath}/user/userEmail" method="post">
        <input type="submit" value="添加用户邮箱">
    </form>
</body>
</html>
